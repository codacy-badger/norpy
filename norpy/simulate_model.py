...
def backward_induction_procedure(
    model_object, state_space_info, periods_rewards_systematic
):
    """
...
def simulate(model_object):
    ...
    args = [
        ...
        model_object.periods_draws_sims,
        model_object.edu_spec_max,
        model_object.coeffs_common,
        model_object.coeffs_work,
        model_object.delta,
        model_object.sample_edu_start,
        model_object.sample_types,
        model_object.sample_lagged_start,
    ]
