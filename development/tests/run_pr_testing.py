...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--property', type=float, help='hours to run for property tests',
                        default=0.001, dest='property')

    parser.add_argument('-rob', '--robustness', type=float,
                        help='hours to run for robustness tests', default=0.001, dest='robustness')

    parser.add_argument('-reg', '--regression', type=float,
                        help='number of regression tests to run', default=1, dest='regression')
